...
3. **Make a plan.** Before writing code, write a short plan with your phases and keep it updated as you work. Keep all planning and progress documents under `.cio/` — never pollute the repo root.
