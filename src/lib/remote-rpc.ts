...
export const REMOTE_CHANNEL_AUTHORIZATION: Readonly<Record<string, RemoteChannelAuthorization>> = {
  ...
  'scope:updateLayout': { scope: 'workspace.write', stepUp: 'none' },
  'scope:updateAppearance': { scope: 'workspace.write', stepUp: 'none' },
  ...
  'agent:deleteTemporaryMessages': { scope: 'conversation.control', stepUp: 'none' },
  'agent:abort': { scope: 'conversation.control', stepUp: 'none' },
  'agent:answerQuestion': { scope: 'conversation.control', stepUp: 'none' },
  'agent:answerSecret': { scope: 'conversation.control', stepUp: 'none' },
  ...
  'prototypePreview:readChunk': { scope: 'workflow.read', stepUp: 'none' },
  ...
  'prd:ensureWorkflow': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:chooseEntry': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:beginDrafting': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:createDraft': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:saveDraft': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:createVersion': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:addAnnotation': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:updateAnnotation': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:resolveAnnotation': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:finalize': { scope: 'workflow.write', stepUp: 'conditional', requiresStepUp: true },
  'prd:openInEditor': { scope: 'workflow.write', stepUp: 'conditional' },
  'prd:revealInFiles': { scope: 'workflow.write', stepUp: 'conditional' },
  ...
  'audit:restoreOffer': { scope: 'workflow.write', stepUp: 'conditional' },
  ...
  'git:defaultBranch': { scope: 'git.read', stepUp: 'none' },
  'git:log': { scope: 'git.read', stepUp: 'none' },
  'git:remoteUpdates': { scope: 'git.read', stepUp: 'none' },
  ...
  'git:setRemoteUrl': { scope: 'git.write', stepUp: 'none' },
  'git:removeRemote': { scope: 'git.write', stepUp: 'none' },
  'git:fetch': { scope: 'git.write', stepUp: 'none' },
  'git:pull': { scope: 'git.write', stepUp: 'none' },
  'git:syncWith': { scope: 'git.write', stepUp: 'none' },
  'git:syncPeers': { scope: 'git.read', stepUp: 'none' },
