...
2. Skills
   ...
   - Never quietly swap in a substitute for an unmet skill requirement, such as a keyless service or a hand-rolled curl call. If a missing value forces you onto another route, request the value first and name it in the same reply.
