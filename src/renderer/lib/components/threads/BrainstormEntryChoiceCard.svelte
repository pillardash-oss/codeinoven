...
>
  <div class="flex items-center gap-2 border-b px-4 py-2.5">
    ...
    {/if}
    <CardFoldToggle bind:folded label="planning choice" class={onClose ? '' : 'ml-auto'} />
  </div>
        ...
        >
          ...
          <span class="min-w-0">
            ...
            <span class="mt-0.5 block text-[0.6875rem] leading-relaxed text-muted">
              Research the real context, answer focused questions, and align the direction before
              the spec.
            </span>
          </span>
        </button>
